    ...
    <div class="classin-container">
      <div class="classin-content">
        ...
        <p class="text-justified">
          We use the online classroom application.
          <b> Classin</b> to deliver our classes.
          <b> Classin</b> is an all-inclusive application that allows students
          to connect with teachers all around the world. When you create a
          <b> Classin </b>
          student account, our team will add your account to join the online SP
          school account. From there, you will have access to a calendar showing
          all approaching classes and the pre- and post- classroom activities to
          complete.
        </p>
